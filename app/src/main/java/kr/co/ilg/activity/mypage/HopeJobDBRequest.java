...
public class HopeJobDBRequest extends StringRequest {
    final static private String URL = "http://rickshaw.dothome.co.kr/Insert3.php";
    private Map<String, String> parameters;



    public HopeJobDBRequest(String key,String num, String worker_email,String job_code, String hj_career, Response.Listener<String> listener) { //생성자 부분이라 콜백메소드는 생략
        // data            응답 처리 리스너
