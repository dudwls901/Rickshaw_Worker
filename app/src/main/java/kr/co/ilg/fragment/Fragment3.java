...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        workInfoArrayList.add(new ListViewItem("빌라 건축", "2020-06-14", "150,000", "전기", "서울 영등포구 여의나루로57", "개미인력소", "지급완료", true));
        workInfoArrayList.add(new ListViewItem("제일아파트 건축", "2020-06-17", "130,000", "페인트", "서울 영등포구 당산로 219", "베짱이인력소", "지급예정", false));
        workInfoArrayList.add(new ListViewItem("자이아파트 신축", "2020-06-20", "160,000", "건축", "서울 영등포구 양평로24길 9", "사람인력소", "지급예정", false));
        workInfoArrayList.add(new ListViewItem("신송센터빌딩 철거", "2020-06-23", "160,000", "철거", "서울 영등포구 양평로24길 10", "돈돈인력소", "지급예정", false));
